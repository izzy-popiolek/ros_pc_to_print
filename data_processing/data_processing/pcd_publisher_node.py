...
class PCDPublisher(Node):
    ...
    def __init__(self):
        ...
        # Create publishers
        self.pcd_publisher = self.create_publisher(sensor_msgs.PointCloud2, 'continuous_pcd', 10)
        self.pcd_viz_publisher = self.create_publisher(sensor_msgs.PointCloud2, 'pcd', 10)  # For RViz visualization
        self.status_publisher = self.create_publisher(String, 'data_process_status', 10)

        # Convert point cloud once
        ...
        # Send initial status message once
        status_msg = String()
        status_msg.data = "Point cloud loaded and publishing started"
        self.status_publisher.publish(status_msg)
        
    def timer_callback(self):
        # Publish point cloud on both topics for processing and visualization
        self.pcd_publisher.publish(self.pcd)
        self.pcd_viz_publisher.publish(self.pcd)  # For RViz visualization
